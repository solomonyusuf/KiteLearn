...
namespace KiteLearn.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync( IFormFile file, string returnUrl = null)
        {
            ...
            {
                _UploadController.Upload(file);
                var user = new ApplicationUser { UserName = Input.Email, Email = Input.Email, ImgPath = file.FileName };
