...
namespace KiteLearn.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<EmployeeModel>>> GetEmployees()
        {
            return await _context.Employees
                ...
                ImageSrc = String.Format("{0}://{1}{2}/StaticFiles/{3}",Request.Scheme,Request.Host,Request.PathBase,x.ImageName)
                })
                .ToListAsync();
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutEmployeeModel(Guid id, [FromForm]EmployeeModel employeeModel)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<EmployeeModel>> DeleteEmployeeModel(Guid id)
        {
            var employeeModel = await _context.Employees.FindAsync(id);
            if (employeeModel == null)
            {
        ...
        public async Task<string> SaveImage(IFormFile imageFile)
        {
            ...
            var imagePath = Path.Combine(_hostEnvironment.ContentRootPath, "StaticFiles", imageName);
